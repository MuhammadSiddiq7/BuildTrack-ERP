...
class MonthlyPayrollExport implements FromCollection, WithHeadings, WithStyles, WithEvents
{
    ...
    {
        // Get payrolls based on the month and year
        $payrolls = Payroll::with(['employee', 'companyBank', 'project'])
            ->whereMonth('pay_date', $this->month)
            ->whereYear('pay_date', $this->year)
            ->get();
    ...
    public function registerEvents(): array
    {
        return [
            BeforeSheet::class => function (BeforeSheet $event) {
                ...
                $title = "Monthly PayRoll Report for {$monthName} {$this->year}";
