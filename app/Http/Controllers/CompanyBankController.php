...
class CompanyBankController extends Controller
{
 use AuthorizesRequests;
    ...
    public function index()
    {
        ...
        $banks = CompanyBank::latest()->get();
        $trashCount = CompanyBank::onlyTrashed()->count();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('company.bank.index')->with('success', 'Bank added successfully.');
        } catch (Exception $ex) {
            DB::rollBack();
    ...
    public function edit($id)
    {
        ...
        $bank = CompanyBank::findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('company.bank.index')->with('success', 'Bank updated successfully.');
        } catch (Exception $ex) {
            DB::rollBack();
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            logUserActivity('Company Bank', 'Deleted Bank ' . $bankName, $bank->id, 'Bank');
            ...
            DB::commit();
            return redirect()->route('company.bank.index')->with('success', 'Bank deleted successfully.');
        } catch (Exception $ex) {
            DB::rollBack();
    ...
    public function trash()
    {
        ...
        $banks = CompanyBank::onlyTrashed()->latest()->get();
        return view('bank.trash', compact('banks'));
    }

    public function restore($id)
    {
        $bank = CompanyBank::onlyTrashed()->findOrFail($id);
        $bank->restore();
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('company.bank.index')->with('success', 'Bank restored successfully.');
        } catch (Exception $ex) {
            DB::rollBack();
