...
@section('title', 'Item C Type Houses')
@section('header-title', 'Item C Type Houses')
        ...
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
                @can('item_c_import')
                   <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#importModal">
                        <i class="bi bi-upload me-1"></i> Import C Type Houses
                    </button>
                @endcan



                @can('item_c_trash_view')
                    <a href="{{ route('item.trash.c') }}"
...
<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow-lg">
      ...
      <form action="{{ route('items.import.c') }}" method="POST" enctype="multipart/form-data">
        @csrf
