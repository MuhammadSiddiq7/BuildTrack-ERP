...
@section('title', 'Item D Type Houses')
@section('header-title', 'Item D Type Houses')
        ...
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
                @can('item_d_import')
                   <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#importModal">
                        <i class="bi bi-upload me-1"></i> Import D Type Houses
                    </button>
                @endcan
            <div class="d-flex align-items-center gap-2">


                @can('item_d_trash_view')
                    <a href="{{ route('item.trash.d') }}"
...
<div class="modal fade" id="importModal" tabindex="-1" aria-labelledby="importModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content border-0 shadow-lg">
      ...
      <form action="{{ route('items.import.d') }}" method="POST" enctype="multipart/form-data">
        @csrf
