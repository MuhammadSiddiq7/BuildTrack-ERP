                ...
                <div class="card-body">
                    <form action="{{ route('item.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    <label for="items_type"><b>Item Type</b></label>
                                    <select name="items_type" id="items_type" class="form-control" required>
                                        <option value="A" {{ $item->items_type == 'ATH' ? 'selected' : '' }}>A</option>
                                        <option value="B" {{ $item->items_type == 'BTH' ? 'selected' : '' }}>B</option>
                                        <option value="C" {{ $item->items_type == 'CTH' ? 'selected' : '' }}>C</option>
                                        <option value="D" {{ $item->items_type == 'DTH' ? 'selected' : '' }}>D</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="per_house_qty" name="per_house_qty"
                                        value="{{ $item->per_house_qty }}" placeholder="Enter Qty per house"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="specification" name="specification"
                                        placeholder="Enter specification" value="{{ $item->specification }}"
                                        class="form-control">
                                    @error('specification')
