        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    @can('bank_create')
                        <a href="{{ route('company.bank.create') }}" class="btn btn-primary">Create Bank</a>
                    @endcan
                    @can('bank_trash_view')
                        <a href="{{ route('company.bank.trash') }}" class="btn btn-danger d-flex align-items-center gap-2 ms-auto"
                            title="Trashed Banks">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                @can('bank_edit')
                                                    <a class="dropdown-item" href="{{ route('company.bank.edit', $bank->id) }}">
                                                        <i class="bi bi-pencil-square"></i> Edit
                                                    </a>
                                                @endcan
                                                @can('bank_trash')
                                                    <form action="{{ route('company.bank.destroy', $bank->id) }}" method="POST"
