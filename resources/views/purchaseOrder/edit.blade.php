...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('purchaseOrder.update', $itemDemand->id ) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <table class="table table-striped" id="datatables-reponsive-suppliers">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="radio" name="selected_supplier[{{ $entry['item']->id }}]" value="{{ $supplier->id }}" {{ $isRecommended ? 'checked' : '' }}>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
